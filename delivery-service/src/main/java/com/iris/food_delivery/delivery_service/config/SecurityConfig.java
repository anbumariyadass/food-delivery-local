package com.iris.food_delivery.delivery_service.config;
...
import com.iris.food_delivery.delivery_service.jwt.JwtFilter;
	    ...
	    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        http
	            ...
	            .authorizeHttpRequests(auth -> auth
	                .requestMatchers("/delivery/ping").permitAll() // Public endpoints
